...
<div align="justify">
<i><b>Olá</b> :wave:, sou a <code>Ingrid</code>, tenho 19 anos, moro em BH e sou estudante. Atualmente sou <code>estudante</code> no curso de Engenharia da Computação do <a href="https://newtonpaiva.br/" target="_blank">Centro Universitário Newton Paiva</a>:man_teacher:<br />
</div>
